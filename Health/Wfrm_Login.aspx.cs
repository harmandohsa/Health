...
namespace Health
{
    public partial class Wfrm_Login : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                string Clave = ClUtilitarios.Encrypt("2", true);
        ...
        void Ingreso()
        {
            ...
            else
            {
                ...
                else if ((Convert.ToDateTime(DatosUsuario.Tables["Datos"].Rows[0]["Fecha_Alta"]) > ClUtilitarios.FechaDB()))
                {
                ...
                else if ((Convert.ToDateTime(DatosUsuario.Tables["Datos"].Rows[0]["Fecha_Vence"]) < ClUtilitarios.FechaDB()))
                {
